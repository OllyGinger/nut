use bootloader_x86_64_bios::{racy_cell::RacyCell, BiosFramebufferInfo, PixelFormat};
use core::{fmt, ptr};
...
pub fn init(info: BiosFramebufferInfo) {
    let framebuffer = unsafe {
        core::slice::from_raw_parts_mut(info.region.start as *mut u8, info.region.len as usize)
    };
