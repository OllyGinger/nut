use bootloader_x86_64_bios::{
    disk_access::{AlignedArrayBuffer, AlignedBuffer},
    PixelFormat,
};

#[repr(C, packed)]
struct VbeInfoBlock {
    signature: [u8; 4], // should always be "VESA"
    version: u16,
    oem_string_ptr: u32,
    capabilities: u32,
    video_mode_ptr: u32,
    total_memory: u16,     // Number of 64K blocks
    oem: [u8; 512 - 0x14], // Reserved for OEMs to use
}
